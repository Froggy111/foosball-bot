    ...
    if ((tmp_adc_is_conversion_on_going_regular == 0UL) &&
      ...
      if (hadc->Init.OversamplingMode == ENABLE) {
        ...
        MODIFY_REG(hadc->Instance->CFGR2,
                   ADC_CFGR2_OVSR | ADC_CFGR2_OVSS | ADC_CFGR2_TROVS |
                       ADC_CFGR2_ROVSM,
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef *hadc) {
  ...
  __HAL_ADC_DISABLE_IT(hadc,
                       (ADC_IT_AWD3 | ADC_IT_AWD2 | ADC_IT_AWD1 | ADC_IT_JQOVF |
                        ADC_IT_OVR | ADC_IT_JEOS | ADC_IT_JEOC | ADC_IT_EOS |
                        ADC_IT_EOC | ADC_IT_EOSMP | ADC_IT_RDY));

  /* Reset register ISR */
  __HAL_ADC_CLEAR_FLAG(hadc, (ADC_FLAG_AWD3 | ADC_FLAG_AWD2 | ADC_FLAG_AWD1 |
                              ADC_FLAG_JQOVF | ADC_FLAG_OVR | ADC_FLAG_JEOS |
                              ADC_FLAG_JEOC | ADC_FLAG_EOS | ADC_FLAG_EOC |
 ...
 */
HAL_StatusTypeDef
HAL_ADC_UnRegisterCallback(ADC_HandleTypeDef *hadc,
                           HAL_ADC_CallbackIDTypeDef CallbackID) {
  HAL_StatusTypeDef status = HAL_OK;
 ...
 */
HAL_StatusTypeDef
HAL_ADC_AnalogWDGConfig(ADC_HandleTypeDef *hadc,
