 ...
 * index should start form 0x10 to avoid using the reserved device string desc
 * indexes
 */
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
extern USBD_DescriptorsTypeDef XXX_Desc; /* Replace 'XXX_Desc' with your active
                                            USB device class, ex: HID_Desc */
